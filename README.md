Project: SuperMarket Sales & Velocity Analysis
📋 Project Overview
...
🛠️ Technical Stack
SQL (MySQL): Built 6+ views for executive reporting (Sales Velocity, City Performance, KPIs).

Excel/CSV: Initial data profiling and cleaning.

Tableau: Branch Performance Heatmaps.
...
💡BTSA Recommendation: 
. Real-Time "Sales Velocity" Inventory Rebalancing
